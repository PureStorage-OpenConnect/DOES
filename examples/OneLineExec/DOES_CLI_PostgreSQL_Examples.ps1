...
#           C:\Users\<Username>\AppData\Roaming\Pure Storage\D.O.E.S\Config\Analytics.conf                 #
#                                                                                                          #
############################################################################################################
...
############################
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 


##Check All ADD capabilities are working - Web
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 10 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 


##Check All ADD capabilities are working -File
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithoutIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexesLOB --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithoutIndexesLOB --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 

#Check export capabilities 

.\DOES.Cli.exe --engine data --function export --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --folder Z:\DataEngineFiles3Export --verbose 

#Check search works well 

.\DOES.Cli.exe --engine data --function search --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --queryoperation LeftOuterJoin
.\DOES.Cli.exe --engine data --function search --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --queryoperation UnionAll

#Check delete works 
.\DOES.Cli.exe --engine data --function remove --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8  --numberofthreads 8
 
#Check if udate works for replace and LOB variants 
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function update --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8  --numberofthreads 8
...
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function update --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8  --numberofthreads 8 --replace --folder $DataFileSourceFolder 
...
##Check All ADD capabilities are working - Web
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 5 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --logdata --testname $TestName --objectname Add_From_Web_Defaults

##Check All ADD capabilities are working -File
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder --logdata --testname $TestName --objectname Add_From_File_WithIndexes
...
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexesLOB --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function export --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --folder $DataFileTargetFolder --verbose 

#Check search works well 
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexesLOB --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function search --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --queryoperation LeftOuterJoin --logdata --testname $TestName --objectname Search_LeftOuterJoin
.\DOES.Cli.exe --engine data --function search --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --queryoperation UnionAll --logdata --testname $TestName --objectname Search_UnionAll

#Check delete works 
.\DOES.Cli.exe --engine data --function remove --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --logdata --testname $TestName --objectname Delete_SingleTest
 
#Check if udate works for replace and LOB variants 

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function update --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --logdata --testname $TestName --objectname Update_WithIndexes

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexesLOB --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function update --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --logdata --testname $TestName --objectname Update_WithIndexesLOB

.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --schematype WithIndexes --tableamplification 8 --numberofthreads 8 --folder $DataFileSourceFolder 
.\DOES.Cli.exe --engine data --function update --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 56 --unit  Gigabytes --tableamplification 8 --numberofthreads 8 --replace --folder $DataFileSourceFolder --logdata --testname $TestName --objectname Update_WithIndexes_And_Replace
...
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --tableamplification 8 Folder $DataFileSourceFolder --logdata --testname $TestName --objectname TestSimple_DeferInitialCheck
...
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --tableamplification 8 Folder $DataFileSourceFolder --logdata --testname $TestName --objectname TestSimple_CyclerTrend
...
.\DOES.Cli.exe --engine data --function clear --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --tableamplification 8 --cleanoperation Drop 
.\DOES.Cli.exe --engine data --function add --hostname $Hostname --databasetype PostgreSQL --databasename $Databasename --username $Username --password $Password --amount 128 --unit  Gigabytes --tableamplification 8 Folder $DataFileSourceFolder --logdata --testname $TestName --objectname TestAdvanced_CyclerTrend
