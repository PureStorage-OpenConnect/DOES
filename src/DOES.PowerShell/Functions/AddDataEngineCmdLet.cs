...
{
    [Cmdlet(VerbsCommon.Add, "DataEngine", DefaultParameterSetName = "MS SQL")]
    public class AddDataEngineCmdLet : Cmdlet
    {
        #region Parameters 
                ...
                if (_driver != null)
                {
                    ...
                    if (_folderPath != null)
                    {
                        ...
                        _task = Task.Run(() =>
                        {
                            ...
                            _controller.ImportFromFile(_folderPath, amountToAddBytes, capturedToken, null);
                        }, _token);
                    }
                    else
                    {
                        ...
                        {
                            var capturedToken = _tokenSource;
                            _controller.ImportFromWeb(amountToAddBytes, capturedToken, null);
                        }, _token);
                    }
                }

                    CreateProgress(_dbname);
        ...
        private void CreateProgress(string databaseIdentifier)
        {
